#!/usr/bin/env python3
"""Minimal CPU smoke test for the archived distance-regularization code.

This script deliberately imports and exercises the historical implementation
without correcting its formulas or restructuring its packages.
"""
...
def main() -> None:
    ...
    logits, reduced_attention, raw_attention, penalty_matrix = outputs
    ...
    print(f"PASS: distance model, penalty matrix, loss, and one optimizer step using {source}")
